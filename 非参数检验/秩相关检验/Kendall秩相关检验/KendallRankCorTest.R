...
KendallRankCorTest<-function(dataset, rowname = NULL, colname = NULL, numvar1 = NULL, numvar2 = NULL,
                              side = "twotail"){
  ...
  #-------------------------------------------------------------------------------------------------
  # DoublePairWilcoxTest -  Perform Spearman Rank Correlationship Test. 
  ...
  # Double Pair TTest
  ErrorMsg<-tryCatch({
    result = cor.test(column1, column2, alternative = side,
                      method = 'kendall')
  ...
  KStatistic = result$statistic[[1]]
  EstiTau  = result$estimate[[1]]
  PValue = result$p.value[[1]]
  
  
  #return result
  return(list(KStatistic = KStatistic,  PValue = PValue, EstiTau = EstiTau))
...
numvar1 = 'pat_age'
numvar2 = 'dp_nervus'
a = KendallRankCorTest(dataset, numvar1 = numvar1, numvar2 = numvar2)
